...
public class NumberINTOWords {
    public static void main(String[] args) {
        System.out.println("reverse = " + reverse(201));
        System.out.println("Count of digits = " +getDigitCount(201));
        numberToWords(201);
    }
    ...
    public static int reverse(int number) {
        ...
        public static void numberToWords(int number) {
            ...
            for (int i = 0; i < leadingZeroes; i++) { // if number = 200 then leadingZeroes = 2
                System.out.println("Zero");
            }
        }
    }
